...
class DisciplinesControllerTest < ActionController::TestCase
  ...
  test "should create discipline" do
    assert_difference('Discipline.count') do
      post :create, discipline: { code: @discipline.code, description: @discipline.description, name: @discipline.name, workload: @discipline.workload }
    end
  ...
  test "should update discipline" do
    patch :update, id: @discipline, discipline: { code: @discipline.code, description: @discipline.description, name: @discipline.name, workload: @discipline.workload }
    assert_redirected_to discipline_path(assigns(:discipline))
  end
